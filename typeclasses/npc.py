...
class YourMom(Object):
    descriptions = [
        u"""Селянка, но поинтеллегентнее, дворянского рода. Закончила школу и молочный техникум. Овуляха по жизни и по интересам. Дети на первом месте, что полезно, ибо всегда помогает деньгами. Изменяет отцу с кем ни попадя. Поженились, похоже, по залету. Один раз изменяла в соседней комнате, когда мне было около пяти лет, а я и тогда все понимал. Наверное, это как-то повлияло на то, что своим девушкам я не доверяю и даже в сексе расслабиться и кончить не могу.""",
        u"""Закончила 8 классов и быдлошарагу. Курит, по её словам, с 16 лет. По профессии не работала, смыслом жизни считает выращивание детей, во всех своих бедах винит тоже их. Родила моего брата в 20 лет. Во сколько вышла замуж я не знаю, но там был какой-то скандал, их родители были против свадьбы (наверно свадьба по залету была). Верит в плохую энергетику, духов и прочую хрень. Считала солнце планетой""",
        u"""Адекватная женщина 41 лвл, иногда может депрессовать и накручиваться. По ее словам, одно время размышляла о выпиле. Курит с 17-ти лет (непостоянно, нерегулярно, по настроению), в то же время переехала в общагу и начала выпивать в компаниях. Сейчас убивается, мол "за всю жизнь ничего, кроме семьи, не добилась, работа говно, зарплата говно, дачи нет (это ее мечта, ну дача)". Работает какой-то там управляющей, въебывает, вроде в месяц около 30к. Два высших химическое и экономическое.""",
        ...
        u"""35 лет, не пьет и не курит, диабет. Работает учителем английского в младших классах и иногда ездит в Финку подрабатывать массажисткой.  Отношения у вас просто пиздец и ничего больше не скажешь. Обожает фотаться, прикольчики на одноклассниках и регулярно ездит к ебырю в другой город, очень бесится, когда бабушка обвиняет мамку, что та не уделяет времени своим детям,""",
        ...
        u"""Поехавшая на религии, четырежды отлежавшая в психушке дура. Не работает, висит у бати на шее. Пока ты был в сосничестве, постоянно тебя пиздила за просто так (наверное поэтому у тебя так плохо с тнями?)""",
...
class YourDad(Object):
    descriptions = [ 
        u"""Еврей старой закалки. Не жлоб, но с жлобинкой такой, небольшой. Пришел к успеху в 90е когда тусил с бандитами, я так понимаю он там чисто числился и иногда их по домам развозил, но тем не менее пацаны пошли в гору вплоть до губернаторства и прочих чинов - и батю с собой потащили. Главный врач областной больнички.""", 
        ...
        u"""Имеет вышку, считает себя элитой, несколько лет назад поднялся на работе, но потом его опять понизили за то что не лижет зад начальству, не приемлет точку зрения, противоположную ему. Два года назад закодировался. Ранее был женат, имеет дочь овер 30 лвл""",
        ...
        u"""Нечто вечно всем недовольное, лежащее на продавленном диване в дырявых трениках с отвисшей мотнёй. В руках бульварная газета и пульт от телевизора с транслируемым политическим ток-шоу. Отцеподобное существо любит царственно почёсывать пивное брюхо, обожает пятничный преферанс и вяленую воблу, готово до хрипоты в горле спорить о преимуществе блесны над мормышкой и макушатника над дождевыми червями.""",
        u"""Профессор кроссвордогадания летом выходит играть в домино прямо в домашних тапочках, бритьё подмышек и дезодоранты считает уделом педерастов. Сортирный генерал категорически отказывается пользоваться обувной ложкой и ситечком для чая. Жлобатько не пьёт шмурдяк в баре биллиардного клуба, а заранее накачивается рядом в киоске-наливайке, где гранчак аналогичной бурды на рубль дешевле.""",
        u"""Диванный князёк кроет жену нецензурной бранью за невымытую тарелку и слабо нагретый ужин, хотя сам не менял носки три недели и мылся «когда последний раз горячая вода в кране была». На бойлер денег скопить надо, экономить на пойле придётся, устанавливать его потом — гембель, сопоставимый по объёмам со строительством БАМа.""",
        ...
        u"""На пенсии. Москвич, закончил 8 классов и какую-то хуйню, сьебался в 90 в мухосранск потому что первая семья развалилась и встретил твою мамку. Работал на дохуище разных работ, много чего умеет. Сейчас проебал все свои удостоверения и работать по специальности по черному уже не может. Работает охранником за 5к +5к пенсии. Из себя представляет либерала антикоммуниста, читает Эхо Москвы и прочее, ненавидит Путлера, любимая тема для разговора - куда катится Раиссия. Курит с 16 лет, сейчас перешел полностью на электронку.""",
    ...
    def at_say(self, speaker, message):
          ...
          if u"лысый" in message:
                self.execute_cmd(u"say Я тебе щас пизды дам!")
          else:
...
class T_Loli(Object):
	...
	CONV_loli = {"START": {"text": "Привет анон. Я %s. Добро пожаловать на Мудач. Снова." % self.key,
                  "links": ["i1", "i2", "i6","END"],
                  "linktexts": ["Кто такие лоли?",
                                "Ты любишь конфеты?",
                                "Что такое Мудач?",
                                "Пока."],
                  "keywords": None,
                  "callback": None},
        "i1": {"text": "Лоли это маленькие девочки. Они миленькие и беззащитные.",
                  "links": ["i2", "START", "END"],
        ...
        "i10": {"text": "Ну ты и тварь... У тебя нет конфет...",
                 ...
                 "keywords": None,
                 "callback": None},
         "i11": {"text": "Ну и тварь же ты... У тебя нет трюфелей...",
                 "links": ["END"],
                 "linktexts": ["[Закончить]"],
                 "keywords": None,
                 "callback": None},                     
...
class Druggist(simpleNPC):
    ...
    def at_object_creation(self):
        ...
        "i2": {"text": "Этот товар закончился. Скоро обещали привезти.",
                 ...
                 "keywords": None,
                 "callback": None},
        "i3": {"text": "У тебя не хватает интернетов. Поднакопи и тогда возвращайся.",
                 "links": ["START", "END"],
                 "linktexts": ["Можно тогда...",
                               "Ну ладно. Досвидания."],
                 "keywords": None,
...
class CmdSera(Command):
    ...
    def func(self):
        caller = self.caller
        talking_to = caller.search(caller.db.last_talk_with, location=caller.location)
        item = caller.search("сера", location=talking_to)
...
class CmdVodorod(Command):
    ...
    def func(self):
        caller = self.caller
        talking_to = caller.search(caller.db.last_talk_with, location=caller.location)
        item = caller.search("водород", location=talking_to)
...
class CmdBottle(Command):
    ...
    def func(self):
        caller = self.caller
        talking_to = caller.search(caller.db.last_talk_with, location=caller.location)
        item = caller.search("бутылка", location=talking_to)
...
class CmdDrugs(Command):
    ...
    def func(self):
        caller = self.caller
        talking_to = caller.search(caller.db.last_talk_with, location=caller.location)
        item = caller.search("вещества", location=talking_to)
...
class Conditer(simpleNPC):
    ...
    def at_object_creation(self):
        ...
        self.locks.add("call:false()")
        self.locks.add("get:false()")
        self.db.desc = "Кондитер. Похож на доктора. Но не доктор."
        #задаем таймер, рандомно срабратывающий
        self.db.last_ticker_deley_value = 0
        self.db.last_ticker_deley_value = random.randint(15, 120)
        tickerhandler.add(self, self.db.last_ticker_deley_value)
        ...
        CONV_cond = {"START": {"text": "Добро пожаловать. Чем могу вам помочь?",
                  "links": ["i1", "i1", "END"],
                  "linktexts": ["Купить шоколадные конфеты - 5 интернетов.",
